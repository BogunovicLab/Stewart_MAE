...
SNP_TABLE_DIR=/sc/arion/projects/ISDS/haleyr/RMAE_OJAY/DATA/VCFs_missense/SNP_TABLES
OUT_DIR=/sc/arion/projects/ISDS/haleyr/RMAE_OJAY/DATA/COUNTS_missense-new_batch
