...
VCF_DIR=/sc/arion/projects/ISDS/haleyr/RMAE_OJAY/DATA/VCFs_missense/RENAMED
HET_VCF_DIR=/sc/arion/projects/ISDS/haleyr/RMAE_OJAY/DATA/VCFs_missense/HET_ALLELIC/
...
## SAMPLE_FILE_PATH=/sc/arion/projects/ISDS/haleyr/RMAE_OJAY/DATA/VCFs_missense/RENAMED/D108.HeterozygousMissenseVariants-noChr_noDup.vcf.gz
...
# tabix -p vcf ${VCF_DIR}/${VCF_ID}.HeterozygousMissenseVariants-noChr_noDup.vcf.gz
...
python3 ${SCRIPTS}/prepare_reference.py --PSEUDOREF True --HETVCF True \
  ...
  --name_ind ${VCF_ID} \
  --vcf_ind ${VCF_DIR}/${VCF_ID}.HeterozygousMissenseVariants-noChr_noDup.vcf.gz \
