...
VCF_DIR=/sc/arion/projects/ISDS/haleyr/RMAE_OJAY/DATA/VCFs_synonymous

# SAMPLE_FILE_PATH=/sc/arion/projects/ISDS/haleyr/RMAE_OJAY/DATA/VCFs_missense/D108_SynonymousVariants_PredictedDeleterious-noChr.vcf 

SAMPLE_FILE_PATH=${1}
SAMPLE_FILE=${SAMPLE_FILE_PATH##*/}
SAMPLE_NAME=${SAMPLE_FILE%%_*}
VCF_ID=`echo $SAMPLE_NAME'_SynonymousVariants_PredictedDeleterious-noChr'`
