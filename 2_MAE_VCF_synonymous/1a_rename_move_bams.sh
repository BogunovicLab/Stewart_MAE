...
inDir=/sc/arion/projects/ISDS/haleyr/RMAE_OJAY/DATA/STAR_ALIGN_synonymous
outDir=/sc/arion/projects/ISDS/haleyr/RMAE_OJAY/DATA/BAMS_ALIGNED_synonymous-new_batch
